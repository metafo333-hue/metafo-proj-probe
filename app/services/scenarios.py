...
# ── B1 企业全景（商业）───────────────────────────────────────────
def scenario_b1_company(name: str, *, jurisdiction: str = "",
    ...
    return _assemble("B1·企业全景", name, ["D11", "D4", "D1"], fan_out(specs, default_timeout=timeout))


# ── C5 制裁/合规风险扫描（尽调·实体筛查·非 PIPL 个人数据）────────────
def scenario_c5_compliance(entity: str, *,
    ...
    pkt = _assemble("C5·制裁合规扫描", entity, ["D8", "D11"], out)
...
def scenario_d2_tech(repo: str, *, ecosystem: str = "PyPI", package: str = "",
    ...
    return _assemble("D2·技术情报", repo, ["D12", "D8"], fan_out(specs, default_timeout=timeout))


# ── E3 信息源可信度（核查·多源交叉）──────────────────────────────
def scenario_e3_source(topic: str, *,
                       _wiki: Callable | None = None,
    ...
    return _assemble("E3·信息源可信度", topic, ["D1", "D6", "D5"], fan_out(specs, default_timeout=timeout))
